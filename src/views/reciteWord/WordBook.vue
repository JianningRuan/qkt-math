  ...
  <div>
    ...
    <div class="main">
      <div class="tab-wrapper">
        <div class="tab flex">
          <div class="tab-item flex1 flex flex-pack-center flex-align-center" :class="{'current' : wordTab === 0}" @click="setTab(0)"><em></em>我的单词书</div>
          <div class="tab-item flex1 flex flex-pack-center flex-align-center" :class="{'current' : wordTab === 1}" @click="setTab(1)"><em></em>推荐单词书</div>
        </div>
      </div>
      <div class="book-list overflow" v-if="wordTab === 0">
      ...
      <div class="book-list overflow" v-if="wordTab === 1">
        <!--推荐-->
...
export default {
  ...
  methods: {
    ...
    getMyBook () {
      this.loading = true
      this.$api.word.getMyBook(this.params).then((res) => {
        if (res.rcode === 300) {
    ...
    getRecommendBook () {
      this.reLoading = true
      this.$api.word.recommendBook(this.reParams).then((res) => {
        if (res.rcode === 300) {
