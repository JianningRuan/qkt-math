<template>
  <div class="wrapper flex flex-v">
    <div class="register-banner-views mr">
      <div class="title">完善资料</div>
      <div class="cont">为了更好地<span>推荐口算提升计划</span>给您，请填写您的基本资料。</div>
    </div>
  ...
  methods: {
    ...
    async getInfo () {
      ...
      if (res.rcode === 300) {
        ...
        if (data.grade && data.grade > 0 && data.grade <= this.gradeList.length) {
...
<style scoped lang="scss" src="./PersonalData.scss"></style>
